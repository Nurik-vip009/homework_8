...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Magic magic = new Magic(7,270, 20, "Potter");
        Berserk berserk = new Berserk(260, 15, "Gatz");
        Medic assistant = new Medic(300, 10, 5, "House");
        Witcher witcher = new Witcher(285,15,"Gargamel");
        Thor thor = new Thor(310,35,"Cristian");
        MindBender mindBender = new MindBender(298,22,"RODNUY");
        Hero[] heroes = {warrior, doc, magic, berserk, assistant, witcher, thor, mindBender};
